...
import models.MA_CNN_Two_Parts as model
...
if __name__ == '__main__':
    ...
    # Set optimizer
    optimizer_1 = torch.optim.Adam(filter(lambda p: p.requires_grad, model_1.parameters()), lr=0.0001)
    ...
    #     os.path.join(checkpoint.save_path, 'checkpoint_020_model_1.pth'))
    ...
    #     os.path.join(checkpoint.save_path, 'checkpoint_020_model_2.pth'))
    ...
    #     os.path.join(checkpoint.save_path, 'checkpoint_020_model_3.pth'))
